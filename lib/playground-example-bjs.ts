...
গ্রেড_গণনা(শিক্ষার্থীরা);`
  ...
  চেষ্টা {
    ...
    লিখো(JSON.শব্দসমূহ(প্রাপ্ত, শূন্য, ২));
  } ধরো (ত্রুটি) {
...
যখন (গণনা <= ৫) {
...

  {
    ...
    code: `সংখ্যা প্রথম = ৫;
সংখ্যা দ্বিতীয় = ১২;
লিখো("🧮 সর্বোচ্চ:", গণিত.সর্বোচ্চ(প্রথম, দ্বিতীয়));
লিখো("🎲 র‍্যান্ডম সংখ্যা:", গণিত.এলোমেলো());`
  },
  {
  title: "ইউজার ইনপুট",
  code: `শব্দ নাম = ইনপুট("👉 আপনার নাম লিখুন: ");
সংখ্যা বয়স = ইনপুট("🎂 আপনার বয়স লিখুন: ");
শব্দ প্রিয়_লেখক = ইনপুট("📚 আপনার প্রিয় লেখকের নাম লিখুন: ");

লিখো(নাম + ", আপনাকে স্বাগতম BanglaScript-এ!");
লিখো("আপনার বয়স: " + বয়স + " বছর");
লিখো("আপনার প্রিয় লেখক: " + প্রিয়_লেখক + " — জানতে পেরে আমরা আনন্দিত!");
লিখো("ধন্যবাদ, আপনাকে " + নাম + "!");`
}
